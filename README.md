...
Anyone can recommend additions or alterations to this course. Please, submit a [pull request on github.com](https://github.com/dmd-program/dmd-400-fa20) or file an issue in the [issue queue](https://github.com/dmd-program/dmd-400-fa20/issues).
